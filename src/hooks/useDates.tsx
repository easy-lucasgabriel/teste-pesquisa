...
export const useDates = () => {
  ...
  const getAllDates = useCallback (async (dateInitial:string, dateFinal:string, premios:any, lotas:any, user: any) => {
    const { status, data } = await Dates.getDate(dateInitial, dateFinal, premios, lotas, user);
